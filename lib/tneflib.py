"""
Ruby version by Trevor Schroeder, tschroed@zweknu.org
(used Mark Simpson's TNEF C library as reference)

Conversion to Python by Petri Savolainen, petri.savolainen@iki.fi
